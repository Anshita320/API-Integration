...
async function fetchWeather() {
    ...
    const apiKey = "3daee5c8708f5da067238877c404ea1f";
    ...
    try {
        ...
        document.getElementById('humidity').innerHTML = `Humidity: ${data.main.humidity}% <img src='images/humidity.png' alt='Humidity' width='20' height='20' style='vertical-align: middle;'/>`;
        document.getElementById('windSpeed').innerHTML = `Wind Speed: ${data.wind.speed} km/h <img src='images/wind.png' alt='Wind' width='20' height='20' style='vertical-align: middle;'/>`;
        ...
        switch (data.weather[0].main.toLowerCase()) {
            ...
            default:        iconPath = 'images/clear.png';
        }
